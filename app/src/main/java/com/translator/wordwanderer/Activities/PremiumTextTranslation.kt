...
import com.translator.wordwanderer.databinding.ActivityPremiumTextTranslationBinding
import java.util.*

class PremiumTextTranslation : AppCompatActivity() {
    private lateinit var binding: ActivityPremiumTextTranslationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_premium_text_translation)
    ...
    private fun navigateToDashboard() {
        ...
        val intent = Intent(this@PremiumTextTranslation, PremiumDashboardActivity::class.java)
