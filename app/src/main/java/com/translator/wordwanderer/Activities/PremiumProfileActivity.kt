...
class PremiumProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupClickListeners(backButton, signOut, changePassword, changeUserName, aboutApp, termcon, share, privacy)  // Modified this line
    }
    ...
    private fun promptUserToLogin() {
        ...
        val intent = Intent(this@PremiumProfileActivity, LoginGuestActivity::class.java)
        startActivity(intent)
        finish()
    }

    private fun setupClickListeners(backButton: TextView, signOut: TextView, changePassword: TextView, changeUserName: TextView,
                                    aboutApp: TextView, termcon: TextView, share: TextView, privacy: TextView) {  // Modified this line
        backButton.setOnClickListener {
            navigateToDashboard()
        }
        privacy.setOnClickListener {
            val intent = Intent(this@PremiumProfileActivity, PrivacyActivity::class.java)
            startActivity(intent)
        }
        aboutApp.setOnClickListener {
            val intent = Intent(this@PremiumProfileActivity, AboutAppActivity::class.java)
            startActivity(intent)
        }
        termcon.setOnClickListener {
            val intent = Intent(this@PremiumProfileActivity, TermsConditionsActivity::class.java)
            startActivity(intent)
        }
        ...
        changePassword.setOnClickListener {
            val intent = Intent(this@PremiumProfileActivity, ChangePasswordActivity::class.java)
            startActivity(intent)
        }
        changeUserName.setOnClickListener {
            val intent = Intent(this@PremiumProfileActivity, ChangeUserNameActivity::class.java)
            startActivity(intent)
        }
    ...
    private fun navigateToDashboard() {
        val intent = Intent(this@PremiumProfileActivity, PremiumDashboardActivity::class.java)
